...
licitacoes = pd.read_csv("/Users/pedroafmelo/Documents/projetos/licitacoes/data/licitacoes.csv", sep = "|")
tradutor = pd.read_csv("../data/tcepb_tradutor_ug.csv", encoding = "latin", sep = ";", names = ["cod_mundv", "idmun_tce"], skiprows= 1)
mun = pd.read_csv("../data/mun.csv", encoding = "latin", sep = ";").query("nome_uf == 'Paraíba'")
